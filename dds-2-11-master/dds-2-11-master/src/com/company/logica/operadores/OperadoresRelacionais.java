    ...
    public static void main(String[] args) {
        ...
        /*
         Notas importantes de se lembrar sobre o operador "==":
            * O Java só consegue comparar os tipos Wrapers, através do operador "==", com números que
        	estão no intervalo de "-128" até "127". Fora desse intervalo, o operador "==" pode causar muita
          confusão quando utilizado com os tipos Wrapers. Utilizado juntamente com os primitivos (que,
          ...
          Wrapers. Isso porque o valor de uma variável sempre será igual a ele mesmo. Repare que, em nosso
